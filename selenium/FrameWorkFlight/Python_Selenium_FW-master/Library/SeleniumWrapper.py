...
class SeleniumWrapper:
    ...
    def send_keyboard_input(self, key):
        time.sleep(1)
        if key not in {'ARROW_DOWN', 'ARROW_UP', 'BACK_SPACE', 'TAB', 'ENTER', 'PAGE_DOWN'}:
    ...
    def js_click_element(self, element):
        ...
        self.log_message(f'Performed JS click on {locator_value}')
    ...
    def js_enter_text(self, element, *, value):
        ...
        self.log_message(f'Performed JS Edit on {locator_value}')
    ...
    def js_scroll_right(self):
        ...
        self.log_message('Scrolling Right')
    
    def js_scroll_left(self):
        self.driver.execute_script('window.scrollBy(-300,0)')
        self.log_message('Scrolling Left')
    ...
    def js_scroll_element(self, element):
        ...
        self.log_message(f'Scrolling to element {locator_value}')
    
    def js_page_down(self):
        self.driver.execute_script('window.scrollTo(0,document.body.scrollHeight)')
        self.log_message('Performed Page Down')
    
    def js_page_up(self):
        self.driver.execute_script('window.scrollTo(document.body.scrollHeight,0)')
        self.log_message('Performed Page UP')
    ...
    @wait_(enabled=False, timeout=10)
